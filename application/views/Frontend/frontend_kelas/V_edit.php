                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <!-- Content -->
                                <!-- form start -->
                                <form action="<?php echo site_url('C_frontend/aksi_edit_kelas') ?>" method="POST">
                                    <input type="hidden" value="<?php echo $tampil_kelas_id['id_kelas'] ?>" name="f_idKelas">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nama Kelas</label>
                                            <input type="text" name="f_kelas" value="<?php echo $tampil_kelas_id['nama_kelas'] ?>" class="form-control" placeholder="Ketik disini">
                                        </div>
                                    </div>
